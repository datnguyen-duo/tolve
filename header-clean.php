...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300;1,400&family=Rubik:wght@300;400;500&display=swap" rel="stylesheet">
    ...
    <!-- Paypal payments -->
	<script
    src="https://www.paypal.com/sdk/js?client-id=AWKbErV7-kar_jBW4j0LDgiKmFxKaWEA8fppgZN6daZAGL8jW_iklF64ViGLHUlHC0a0bwY2hXhURTzx&components=messages"
...
$(window).scroll(function() {    
    ...
    if (scroll >= 300) {
        $(".header").addClass("keepHeader");
    } else {
        $(".header").removeClass("keepHeader");
    }
});
</script>	
